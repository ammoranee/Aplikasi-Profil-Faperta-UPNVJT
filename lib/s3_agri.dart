...
class DoktorAgribisnis extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              LaunchURL('https://dokgri.upnjatim.ac.id/');
            },
          ),
          Text(
            'website',
          ...
          IconButton(
            ...
            color: Color.fromARGB(255, 91, 165, 230),
            onPressed: () {
              LaunchURL('mailto:dokgri@upnjatim.ac.id');
            },
          ),
          Text(
            'email',
        ...
        child: Center(
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Program Doktor Agribisnis merupakan satu – satunya program doktor yang dimiliki oleh UPN “Veteran” Jawa timur. Program doktor agribisnis bertujuan untuk menemukan/ mengembangkan teori gagasan ilmiah baru serta memberikan kontribusi pada pengembangan serta pengamalan ilmu pengetahuan di bidang agribisnis. Sejak di resmikan, Program Doktor Agribisnis, Fakultas Pertanian UPN “Veteran” Jawa Timur sudah mulai menerima mahasiswa baru melalui jalur Ujian Mandiri terpadu yang dikelola langsung oleh Lembaga Pengembangan Pembelajaran dan Penjaminan Mutu (LP3M) UPN “Veteran” Jawa Timur',
              ...
              Text(
                  'Program Doktor S3 Program studi Nomor 911/M/2020 tentang Izin Pembukaan Program Studi Agribisnis Program Doktor,\nFakultas Pertanian, Universitas Pembangunan Nasional “Veteran” Jawa Timur',
                  style: TextStyle(fontSize: 16.0),
                  textAlign: TextAlign.center,
                  ),
              SizedBox(height: 20.0),
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  SizedBox(height: 15.0),
                                                  Text(
                                                    'PENDIDIKAN\nS3- Manajemen SDM Universitas Brawijaya\nS2- Manajemen SDM ITS\nS1- Agribisnis Universitas Brawijaya',
                                                    textAlign: TextAlign.center,
                                                  ),
                                                ],
                                              ),
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  SizedBox(height: 15.0),
                                                  Text(
                                                    'PENDIDIKAN\nS3- Ekonomi Pertanian Universitas Sebelas Maret\nS2- Manajemen Agribisnis Institut Pertanian Bogor\nS1- Sosial Ekonomi Pertanian UPN “Veteran” Jawa Timur',
                                                    textAlign: TextAlign.center,
                                                  ),
                                                ],
                                              ),
                                              ...
                                              child: Column(
                                                children: [
                                                  GestureDetector(
                                                    onTap: () {
                                                      LaunchURL(
                                                          'https://agribis.upnjatim.ac.id/2023/06/08/mahasiswa-universitas-pembangunan-nasional-veteran-jawa-timur-berhasil-mengubah-lahan-kosong-menjadi-taman-toga/');
                                                    },
                                                  child :
                                                  Image.asset(
                                                    'assets/lokakarya-doktor-agribisnis.png',
                                                    height: 150.0,
                                                    width: 150.0,
                                                    fit: BoxFit.cover,
                                                  ),
